#!/usr/bin/env python3
"""Drive a CAR autonomously by vision: first-person camera -> YOLO -> controls.

The car spawns into the SHARED twin world and navigates using only what its camera
...
(ultralytics, pillow). Press Ctrl-C any time — the car is despawned from the server.
"""
import argparse
