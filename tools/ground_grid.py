...
Built by `tools/ky_lidar.py --heightmap`. Used by twin_server.Ground (agent snapping),
tools/city_buildings.py (footprint bases) and the citywide road tools (osm_roads/smooth_roads
draping). Keeping one loader here avoids re-implementing the cm<->scene<->cell math four times.
"""
import json
import os
